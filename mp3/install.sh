...
python3 -m .venv /home/pi/pirate-mp3
source /home/pi/pirate-mp3/.venv/bin/activate
pip3 install /home/pi/pirate-mp3/mp3/requirements.txt
...
add_to_config_text 'su --command "PYTHONPATH=\/home\/pi\/pirate-mp3 \/home\/pi\/pirate-mp3\/.venv\/bin\/python3 -m mp3" --login pi' /etc/rc.local 19
